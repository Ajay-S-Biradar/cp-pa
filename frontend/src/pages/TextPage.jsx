      ...
      <div className="mt-4 flex justify-between">
        ...
        {isEditEnabled && !isEditing && (
          <button
            ...
            className="mt-8 m-1 px-4 h-10 col-span-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex justify-center items-center"
          >
            Edit
          </button>
        )}
        {isUpdateEnabled && isEditing && (
          <CreateSection setIsEditEnabled={setIsEditEnabled} setIsEditing={setIsEditing} isEditing={isEditing} text={text} timer={timer} setTimer={setTimer} id={id} />
        )}
      </div>
