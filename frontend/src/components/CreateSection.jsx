...
const CreateSection = ({ timer, setTimer, id, text }) => {
  ...
  const handleCreate = async () => {
    ...
    // console.log(milisec);
    const res = await axios.post('http://localhost:2345/api/assistant/', {text:text,link_id:id,expiresAt:milisec});
  };
      ...
      <form className="max-w-[13rem] mx-auto">
        ...
        <div className="flex relative">
          ...
          <div
            ...
            className={`${
              dropdown ? '' : 'hidden'
            } absolute right-0 top-5 z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-36 dark:bg-gray-700`}
          >
            <ul
